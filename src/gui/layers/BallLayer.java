...
public class BallLayer extends Layer{
    ...
    public BallLayer(VisualBall ball){
        super();
    ...
    public void paintComponent(Graphics graphics){
        ...
        Rectangle draw = this.rectangleSpaceToViewSpace(new Rectangle(
            this.ball.getPosition(this.alpha).x, this.ball.getPosition(this.alpha).y,
            VisualBall.BALL_DIMENSION.width, VisualBall.BALL_DIMENSION.height
        ));
